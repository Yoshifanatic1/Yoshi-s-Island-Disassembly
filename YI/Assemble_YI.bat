...
%asarVer% --no-title-check --define GameID="%GAMDID%" --define ROMID="%Input1%" --define FileType=5 --define PathToFile="SuperFX/SuperFXCode_YI.asm" ..\Global\AssembleFile.asm SuperFX\SuperFXCode_YI.bin

echo Assembling %ROMNAME% SPC700 engine...
%asarVer% --no-title-check --define GameID="%GAMDID%" --define ROMID="%Input1%" --define FileType=4 --define PathToFile="SPC700/SPC700_Engine_YI.asm" ..\Global\AssembleFile.asm SPC700\SPC700_Engine_YI.bin
...
echo Cleaning up...
if exist ..\%GAMDID%\SPC700\SPC700_Engine_YI.bin del ..\%GAMDID%\SPC700\SPC700_Engine_YI.bin
if exist ..\%GAMDID%\SuperFX\SuperFXCode_YI.bin del ..\%GAMDID%\SuperFX\SuperFXCode_YI.bin
