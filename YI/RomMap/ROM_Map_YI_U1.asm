...
macro YI_GameSpecificAssemblySettings()
	...
	%SetROMToAssembleForHack(YI_U, !ROMID)
endmacro
...
macro YI_LoadGameSpecificMainSNESFiles()
	...
	incsrc ../SuperFX/SuperFXPtrs.asm
endmacro
...
macro YI_GlobalAssemblySettings()
	...
	!UnusedNativeModeVector1 = $814F
	!UnusedNativeModeVector2 = $814F
	!NativeModeCOPVector = $814F
	!NativeModeBRKVector = $814F
	!NativeModeAbortVector = $814F
	!NativeModeNMIVector = $0108
	!NativeModeResetVector = $814F
	!NativeModeIRQVector = $010C
	!UnusedEmulationModeVector1 = $814F
	!UnusedEmulationModeVector2 = $814F
	!EmulationModeCOPVector = $814F
	!EmulationModeBRKVector = $814F
	!EmulationModeAbortVector = $814F
	!EmulationModeNMIVector = $814F
	!EmulationModeResetVector = $8000
	!EmulationModeIRQVector = $814F
	%LoadExtraRAMFile("SRAM_Map_YI.asm")
endmacro
